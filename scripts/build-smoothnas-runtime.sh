...
LXC2DOCKER_REF="${LXC2DOCKER_REF:-483a5851d3f50383a723785a5d80027fb0539d0c}"
...
git -C "$BUILD_DIR" checkout --quiet --detach "$LXC2DOCKER_REF"
git -C "$BUILD_DIR" reset --quiet --hard "$LXC2DOCKER_REF"
...
git -C "$BUILD_DIR" apply "${PROJECT_DIR}/runtime/patches/lxc2docker-managed-veth-network.patch"
...
echo "built $OUT from LXC2Docker $LXC2DOCKER_REF"
