...
**Status:** Done — backend/API delivery archived; UI remainder completed in
[`unified-tiering-06-snapshot-ui-remainder.md`](./unified-tiering-06-snapshot-ui-remainder.md).
